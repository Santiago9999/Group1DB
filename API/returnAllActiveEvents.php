<?php
	...
	$startTimeRange = $inData["beginning"];
	$endTimeRange = $inData["end"];
	$onePlaceHolder = 1;
	...
	else
	{
		...
		//TODO: make it so that this takes in start/end date and returns events accordingly
		$sql = "SELECT * FROM Events where status='" . $onePlaceHolder . "' ORDER BY sDate ASC, eDate ASC";
